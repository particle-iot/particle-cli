Feature: library contribute

  Scenario: contributing in a directory that doesn't contain a library
    Given I use the fixture named "library/contribute/invalid/nolibrary"
    When I run particle "library contribute"
  ...
  Scenario: contributing a v1 library
    ...
    And I run particle "library contribute"
    Then the output should contain "Library is not valid"
    And the exit status should not be 0

  Scenario: contributing in a directory that contains a library with an invalid name
    Given I use the fixture named "library/contribute/invalid/name"
    When I run particle "library contribute"
    Then the output should contain "Library is not valid"
  ...
  Scenario: contributing in a directory that contains a valid library works first time
    ...
    And I use the fixture named "library/contribute/valid/0.0.1"
    When I run particle "library contribute"
    Then the output should contain "Library test-library-publish was successfully contributed"
    And the exit status should be 0

  Scenario: the contributed library is initially private
  ...
  Scenario: contributing a newer version of a library
    And I use the fixture named "library/contribute/valid/0.0.2"
    When I run particle "library contribute"
    Then the output should contain "Library test-library-publish was successfully contributed"
    And the exit status should be 0
