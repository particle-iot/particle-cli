...
describe('Help & Unknown Command / Argument Handling', () => {
	...
	const commandList = [
		...
		'  config             Manage environment variables and secrets',
		...
		'  profile            Configure and switch between multiple accounts',
	...
	const allCmds = [
		...
		'cloud', 'compile',
		'config env list', 'config env set', 'config env delete', 'config env rollout', 'config env',
		'config secrets list', 'config secrets get', 'config secrets set', 'config secrets update', 'config secrets remove', 'config secrets',
		'config',
		...
		'device-protection status', 'device-protection disable', 'device-protection enable', 'device-protection', 'doctor',
		// 'env-vars list', 'env-vars set', 'env-vars unset', 'env-vars patch', 'env-vars render', 'env-vars',
		...
		'tachyon backup', 'tachyon restore', 'tachyon identify', 'tachyon factory-restore', 'tachyon',
		...
		'usb setup-done', 'usb configure', 'usb cloud-status', 'usb network-interfaces', 'usb send-request', 'usb',
