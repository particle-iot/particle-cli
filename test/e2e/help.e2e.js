...
describe('Help & Unknown Command / Argument Handling', () => {
	...
	const commandList = [
		...
		// '  env-vars           Create, update, list and remove environment variables',
	...
	const allCmds = [
		...
		'cloud', 'compile',
		'config env list', 'config env set', 'config env unset', 'config env patch', 'config env render', 'config env rollout', 'config env',
