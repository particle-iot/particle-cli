...
describe('Help & Unknown Command / Argument Handling', () => {
	...
	const allCmds = ['binary inspect', 'binary', 'call', 'cloud claim',
		...
		'nyan', 'preprocess', 'product list', 'product device list',
		'product device add', 'product device', 'product', 'project create',
		'project', 'publish', 'serial list', 'serial monitor', 'serial identify',
		'serial wifi', 'serial mac', 'serial inspect', 'serial flash',
		'serial claim', 'serial', 'setup', 'subscribe', 'token list', 'token revoke',
