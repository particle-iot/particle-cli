...
describe('Help & Unknown Command / Argument Handling', () => {
	...
	const commandList = [
		...
		'  integration        Manage integrations that react to device event streams',
	...
	const allCmds = [
		...
		'config secrets list', 'config secrets get', 'config secrets set', 'config secrets delete', 'config secrets',
		'config',
		...
		'integration create', 'integration list', 'integration delete', 'integration POST', 'integration GET', 'integration',
		...
		'usb setup-done', 'usb configure', 'usb cloud-status', 'usb network-interfaces', 'usb env', 'usb send-request', 'usb',
