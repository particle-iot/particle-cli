...
describe('Logic Function Commands', () => {
	...
	const help = [
		...
		'           This command can be also executed as lf list [options]',
		'  get      Downloads the Logic Function.',
		'           This command can be also executed as lf get [options]',
		'  create   Creates a Logic Function.',
		'           This command can be also executed as lf create [options]',
		'  execute  Executes a Logic Function with user provided data.',
		'           This command can be also executed as lf execute [options]',
		'  deploy   Deploys a Logic Function to the cloud.',
		'           This command can be also executed as lf deploy [options]',
		'  disable  Disables a Logic Function in the cloud.',
		'           This command can be also executed as lf disable [options]',
		'  enable   Enables a Logic Function in the cloud.',
		'           This command can be also executed as lf enable [options]',
		'  delete   Deletes a Logic Function from the cloud.',
		'           This command can be also executed as lf delete [options]',
		'  logs     Shows logs from a Logic Function.',
		'           This command can be also executed as lf logs [options]',
		'',
		'Global Options:',
