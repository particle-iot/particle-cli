...
var settings = {
	...
	updates: {
		'2b04:d006': {
			...
			otaRegion: 'photon-bootloader@2.2.0+lto.bin',
			otaFlag: 'ota-flag-a5.bin',
			systemFirmwareOne: 'photon-system-part1@2.2.0.bin',
			systemFirmwareTwo: 'photon-system-part2@2.2.0.bin'
		},
		'2b04:d008': {
			// Need to flash Bootloader and OTA Flag before system parts for Photon/P1
			// because as soon as the system parts are flashed they will change the location
			// of DFU read/write functions which live in system firmware.
			otaRegion: 'p1-bootloader@2.2.0+lto.bin',
			otaFlag: 'ota-flag-a5.bin',
			systemFirmwareOne: 'p1-system-part1@2.2.0.bin',
			systemFirmwareTwo: 'p1-system-part2@2.2.0.bin'
		},
		'2b04:d00a': {
			// The bin files MUST be in this order to be flashed to the correct memory locations
			systemFirmwareOne:   'electron-system-part2@2.2.0.bin',
			systemFirmwareTwo:   'electron-system-part3@2.2.0.bin',
			systemFirmwareThree: 'electron-system-part1@2.2.0.bin',
			otaRegion: 'electron-bootloader@2.2.0+lto.bin',
			otaFlag: 'ota-flag-a5.bin'
		},
		'2b04:d00c': {
			systemFirmwareOne: 'argon-system-part1@2.2.0.bin',
			radioStack: 'argon-softdevice@2.2.0.bin',
			otaRegion: 'argon-bootloader@2.2.0.bin',
			otaFlag: 'ota-flag-a5.bin'
		},
		'2b04:d00d': {
			systemFirmwareOne: 'boron-system-part1@2.2.0.bin',
			radioStack: 'boron-softdevice@2.2.0.bin',
			otaRegion: 'boron-bootloader@2.2.0.bin',
			otaFlag: 'ota-flag-a5.bin'
		},
		'2b04:d00e': {
		...
		'2b04:d017': {
			systemFirmwareOne: 'bsom-system-part1@2.2.0.bin',
			radioStack: 'bsom-softdevice@2.2.0.bin',
			otaRegion: 'bsom-bootloader@2.2.0.bin',
			otaFlag: 'ota-flag-a5.bin'
		},
		'2b04:d018': {
		...
		'2b04:d019': {
			systemFirmwareOne: 'b5som-system-part1@2.2.0.bin',
			radioStack: 'b5som-softdevice@2.2.0.bin',
			otaRegion: 'b5som-bootloader@2.2.0.bin',
			otaFlag: 'ota-flag-a5.bin'
		},
		'2b04:d01a': {
			systemFirmwareOne: 'tracker-system-part1@2.2.0.bin',
			radioStack: 'tracker-softdevice@2.2.0.bin',
			otaRegion: 'tracker-bootloader@2.2.0.bin',
			otaFlag: 'ota-flag-a5.bin'
		},
	},
};
